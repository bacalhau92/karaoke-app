...
export const MusicBarsIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect x="4" y="10" width="4" height="10" rx="1" fill="currentColor" style={{ animation: 'bounce 1s infinite' }}></rect>
        <rect x="10" y="5" width="4" height="15" rx="1" fill="currentColor" style={{ animation: 'bounce 1.2s infinite' }}></rect>
        <rect x="16" y="12" width="4" height="8" rx="1" fill="currentColor" style={{ animation: 'bounce 0.8s infinite' }}></rect>
        <style>{`
            @keyframes bounce {
